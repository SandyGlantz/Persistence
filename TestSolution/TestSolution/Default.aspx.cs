...
namespace ChallengeHeroMonsterClassesPart2
{
    ...
    class Character
    {
        ...
        public int Attack(Dice diceOriginalname)
        {
            // NOTE !!!!! THIS dice (now named diceOriginalname)
            // is NOT !!  the same as the Dice dice instantiated
            // in Page_Load for class Dice sequence below

            diceOriginalname.Sides = this.DamageMaximum;
            return diceOriginalname.Roll();
        }


        // damage is only a placeholder for an int
    ...
    class Dice
    {
        public int Sides { get; set; } // this is a property of Dice class
